...
import com.tcmj.pm.conflicts.data.*;
...
//    }
    ...
    public void test_01_STestcase() {
        ...
        String desc = (String)
        conflictbar.getCausingBars().get(0).getProperty("description");

        assertEquals("description", "Januar bis März", desc);
