...
public class SpreadTest4 extends ApplicationFrame
{

    public SpreadTest4(String s)
    {
        super(s);
    ...
    {
        SpreadTest4 periodaxisdemo3 = new SpreadTest4("JFreeChart: PeriodAxisDemo3.java");
