 ...
 * <p>
 * The report date is point in time when we 'look' at my milestone
 * <p>
 * The milestone date is the point in time what my milestone is atm.
...
public class DataPoint implements Comparable<DataPoint> {
     ...
     * <p>
     * Invalid datapoints are points in the lower right half of the chart</p>
     * <p>
     * Per definition does a MTA chart only have points on the left upper half</p>
